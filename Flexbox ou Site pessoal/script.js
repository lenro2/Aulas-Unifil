...
let abertoMusica = false;
function openMusica() {
    const musica = document.getElementById("musica");
    const sinalMusica = document.getElementById("sinalMusica");
    const musicaTitle = document.getElementById("musicaTitle");
    if (abertoMusica == false) {
        musica.style.display = "block";
        sinalMusica.textContent = "⬇"
        musicaTitle.classList.add("buttonOpened");
        abertoMusica = true;
    } else {
        musica.style.display = "none";
        sinalMusica.textContent = "→";
        musicaTitle.classList.remove("buttonOpened");
        abertoMusica = false;
    };
};